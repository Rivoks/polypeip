...
class LinksAddPage extends StatefulWidget {
  @override
  _LinksAddPageState createState() => _LinksAddPageState();
}

class _LinksAddPageState extends State<LinksAddPage> {
  ...
  Widget buildTitle() {
    return Container(
      ...
      child: CustomText(
        text: "Remplissez les champs pour ajouter un lien",
