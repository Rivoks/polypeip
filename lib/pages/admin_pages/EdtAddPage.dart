...
class EdtAddPage extends StatefulWidget {
  @override
  _EdtAddPageState createState() => _EdtAddPageState();
}

class _EdtAddPageState extends State<EdtAddPage> {
  File _image;
  ...
  Widget buildTitle() {
    return Container(
      ...
      child: CustomText(
        text: "Remplissez les champs pour ajouter un plan / EDT",
        fontColor: FontColor.darkGrey,
        fontSize: FontSize.md,
        fontWeight: FontWeight.w500,
        alignment: TextAlign.center,
  ...
  Widget buildSubmitButton() {
    return Container(
      ...
      child: CustomRoundedButton(
        ...
        borderColor: blue,
        onPressed: () => addEdt(nameTFC.text, _image, context: context).then(
