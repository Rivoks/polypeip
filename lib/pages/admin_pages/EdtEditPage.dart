...
class EdtEditPage extends StatefulWidget {
  EdtEditPage({this.planEdtId, this.initialName});
  final String planEdtId;
  final String initialName;

  @override
  _EdtEditPageState createState() => _EdtEditPageState();
}

class _EdtEditPageState extends State<EdtEditPage> {
  File _image;
  ...
  void initState() {
    ...
    setState(() {
      nameTFC.text = widget.initialName;
    });
  }
  ...
  Widget buildTitle() {
    return Container(
      ...
      child: CustomText(
        text: "Remplissez les champs pour modifier un EDT",
        fontColor: FontColor.darkGrey,
        fontSize: FontSize.md,
        fontWeight: FontWeight.w500,
        alignment: TextAlign.center,
  ...
  Widget buildSubmitButton() {
    return Container(
      ...
      child: CustomRoundedButton(
        ...
        borderColor: blue,
        onPressed: () => _image == null && nameTFC.text == widget.initialName
            ? Navigator.pop(context)
            : editEdt(widget.planEdtId, nameTFC.text, _image, context: context)
                .then(
