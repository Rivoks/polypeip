...
class PlanEdtAddPage extends StatefulWidget {
  @override
  _PlanEdtAddPageState createState() => _PlanEdtAddPageState();
}

class _PlanEdtAddPageState extends State<PlanEdtAddPage> {
  File _image;
