...
class PostMessageriePage extends StatefulWidget {
  PostMessageriePage({@required this.messageId});

  final String messageId;

  @override
  _PostMessageriePageState createState() => _PostMessageriePageState();
}

class _PostMessageriePageState extends State<PostMessageriePage> {
