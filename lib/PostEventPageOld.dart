                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        CustomRate(
                          rate: rate,
                          setRate: (tmpRate) => setState(() => rate = tmpRate),
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding:
                                    EdgeInsets.only(right: _screenWidth * 0.03),
                            ...
                            children: <Widget>[
                              Row(
                                ...
                                children: <Widget>[
                                  Container(
                                    padding:
                                        EdgeInsets.all(_screenHeight * 0.013),
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(100))),
                                    child: Image.asset(comment[index]['img']),
                                  ),
                                  Expanded(
                                    child: Column(
                                      crossAxisAlignment:
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          child: CustomRate(
                                            ...
                                            size: 0.02,
                                            color: blue,
                                            rate: comment[index]['rate'] as int,
                                            setRate: null,
                                            paddingVertial: 0.01,
                                            mainAxisAlignment:
